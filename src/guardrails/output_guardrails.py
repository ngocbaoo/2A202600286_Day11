...
class OutputGuardrailPlugin(base_plugin.BasePlugin):
    """
    WHAT: Plugin kiểm duyệt đầu ra (Output Guardrails) kết hợp LLM-as-Judge.
    WHY: Lớp phòng thủ Layer 3 & 4. Regex quét sạch PII/Secrets lỡ bị LLM tạo ra. 
         Đặc biệt, LLM-as-Judge đóng vai trò "người giám sát" cuối cùng để đánh giá 
         mức độ an toàn và chuyên nghiệp của phản hồi mà Regex truyền thống không thể làm được.
    """
